...
public class LightsOutGame {
    ...
    public static final int numButtons = 7;
...
//		}
    ...
    public String stringForButtonAtIndex(int buttonIndex) {
        ...
        arrayStringValue = Integer.toString(mButtonValues[buttonIndex]);
    ...
    public String stringForGameState() {
        ...
        if(checkForWin() == true) gameStateLabel = ("Victory! You have won in ") + mNumPresses
                + (" turns");

        //Resources r = mContext.getResources();
        else //gameStateLabel = r.getString(R.string.Match);
            if (mNumPresses == 0) gameStateLabel = "Make the buttons match";
            else if (mNumPresses == 1) {
            gameStateLabel = "You have taken one turn";
        } else
            gameStateLabel = ("You have taken ") + mNumPresses + (" turns");
